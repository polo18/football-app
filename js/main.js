...
jQuery(document).ready(function($) {
	...
	var siteCountDown = function() {
		...
		$('#date-countdown, #date-countdown2').countdown('2020/10/18', function(event) {
		  var $this = $(this).html(event.strftime(''
		    + '<span class="countdown-block"><span class="label">%w</span> semaines </span>'
		    + '<span class="countdown-block"><span class="label">%d</span> journées </span>'
